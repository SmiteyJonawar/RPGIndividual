 ...
 * </p>
 * <ul>
 *   <li>{@link smitey.rpgindividual.impl.AEffectImpl#getAfterEName <em>After EName</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AEffectImpl extends MinimalEObjectImpl.Container implements AEffect
{
  ...
  {
    return RpgindividualPackage.Literals.AEFFECT;
  }
    ...
    if (afterEName != null && afterEName.eIsProxy())
    {
      ...
      if (afterEName != oldAfterEName)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RpgindividualPackage.AEFFECT__AFTER_ENAME, oldAfterEName, afterEName));
      }
    }
    return afterEName;
  }
  ...
  public void setAfterEName(AfterE newAfterEName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RpgindividualPackage.AEFFECT__AFTER_ENAME, oldAfterEName, afterEName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RpgindividualPackage.AEFFECT__AFTER_ENAME:
