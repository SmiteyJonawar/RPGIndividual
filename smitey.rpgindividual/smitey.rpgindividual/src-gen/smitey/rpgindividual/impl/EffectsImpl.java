 ...
 * </p>
 * <ul>
 *   <li>{@link smitey.rpgindividual.impl.EffectsImpl#getEffect <em>Effect</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EffectsImpl extends DeclarationImpl implements Effects
{
  ...
  {
    return RpgindividualPackage.Literals.EFFECTS;
  }
  ...
  public EList<Effect> getEffect()
  {
    if (effect == null)
    {
      effect = new EObjectContainmentEList<Effect>(Effect.class, this, RpgindividualPackage.EFFECTS__EFFECT);
    }
    return effect;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RpgindividualPackage.EFFECTS__EFFECT:
