 ...
 * </p>
 * <ul>
 *   <li>{@link smitey.rpgindividual.impl.FloatNumImpl#getI <em>I</em>}</li>
 *   <li>{@link smitey.rpgindividual.impl.FloatNumImpl#getDecimal <em>Decimal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FloatNumImpl extends ActualNumbersImpl implements FloatNum
{
  ...
  {
    return RpgindividualPackage.Literals.FLOAT_NUM;
  }
  ...
  public void setI(int newI)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RpgindividualPackage.FLOAT_NUM__I, oldI, i));
  }
  ...
  public void setDecimal(int newDecimal)
  {
    ...
    decimal = newDecimal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RpgindividualPackage.FLOAT_NUM__DECIMAL, oldDecimal, decimal));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RpgindividualPackage.FLOAT_NUM__I:
        return getI();
      case RpgindividualPackage.FLOAT_NUM__DECIMAL:
        return getDecimal();
    }
