 ...
 * </p>
 * <ul>
 *   <li>{@link smitey.rpgindividual.impl.MovesImpl#getMove <em>Move</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MovesImpl extends DeclarationImpl implements Moves
{
  ...
  {
    return RpgindividualPackage.Literals.MOVES;
  }
  ...
  public EList<Move> getMove()
  {
    if (move == null)
    {
      move = new EObjectContainmentEList<Move>(Move.class, this, RpgindividualPackage.MOVES__MOVE);
    }
    return move;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RpgindividualPackage.MOVES__MOVE:
