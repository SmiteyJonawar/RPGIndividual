 ...
 * </p>
 * <ul>
 *   <li>{@link smitey.rpgindividual.impl.RequireImpl#getLog <em>Log</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequireImpl extends MinimalEObjectImpl.Container implements Require
{
  ...
  {
    return RpgindividualPackage.Literals.REQUIRE;
  }
  ...
  public NotificationChain basicSetLog(Proposition newLog, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RpgindividualPackage.REQUIRE__LOG, oldLog, newLog);
  ...
  public void setLog(Proposition newLog)
  {
    if (newLog != log)
    {
      ...
      if (log != null)
        msgs = ((InternalEObject)log).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RpgindividualPackage.REQUIRE__LOG, null, msgs);
      if (newLog != null)
        msgs = ((InternalEObject)newLog).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RpgindividualPackage.REQUIRE__LOG, null, msgs);
      msgs = basicSetLog(newLog, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RpgindividualPackage.REQUIRE__LOG, newLog, newLog));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RpgindividualPackage.REQUIRE__LOG:
