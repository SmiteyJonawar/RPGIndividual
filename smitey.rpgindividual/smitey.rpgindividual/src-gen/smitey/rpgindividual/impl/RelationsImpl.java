 ...
 * </p>
 * <ul>
 *   <li>{@link smitey.rpgindividual.impl.RelationsImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationsImpl extends DeclarationImpl implements Relations
{
  ...
  {
    return RpgindividualPackage.Literals.RELATIONS;
  }
  ...
  public EList<Type> getType()
  {
    if (type == null)
    {
      type = new EObjectContainmentEList<Type>(Type.class, this, RpgindividualPackage.RELATIONS__TYPE);
    }
    return type;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RpgindividualPackage.RELATIONS__TYPE:
