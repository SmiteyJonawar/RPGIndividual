...
public class RpgindividualGenerator extends AbstractGenerator {
  @Override
  ...
  public CharSequence generateDeathChecker(final Death death) {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public boolean check(Entity user, Entity enemy){");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("HashMap<String, Number> userEntityData = new HashMap<>();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("HashMap<String, Number> enemyEntityData = new HashMap<>();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("for(AttributeData aData : user.getAttributes()){");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("userEntityData.put(aData.getAttributeName(), aData.getNumber());");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("enemyEntityData.put(aData.getAttributeName(), aData.getNumber());");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("}");
    _builder.newLine();
  ...
  public CharSequence generateGame(final String classFileName) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("executeMove(move, moveName, playerEntity, enemyEntity);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("if(deathChecker.check(enemyEntity, playerEntity)){");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("executeMove(move, enemyEntity.getMoveNameList().get(choosenMove), enemyEntity, playerEntity);");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("if(deathChecker.check(playerEntity, enemyEntity)){");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
  ...
  public CharSequence generateEffect() {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public abstract Number changeMove(Move move, String name, Entity user, Entity enemy);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public abstract void doEffect(Move move, String name, Entity user, Entity enemy);    \t");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    return _builder;
  ...
  public CharSequence generateEffectFile(final Effect effect) {
    ...
    _builder.newLine();
    {
      ...
      if (_tripleNotEquals) {
        ...
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("for(AttributeData userAttData : user.getAttributes()){");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("\t");
        _builder.append("userEntityData.put(userAttData.getAttributeName(), userAttData.getNumber());");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("}\t");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("for(AttributeData enemyAttData : enemy.getAttributes()){");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("\t");
        _builder.append("enemyEntityData.put(enemyAttData.getAttributeName(), enemyAttData.getNumber());");
        _builder.newLine();
        _builder.append("\t\t");
        _builder.append("}\t\t\t");
        _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Number changeMove(Move move, String name, Entity user, Entity enemy){");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("HashMap<String, Number> userEntityData = new HashMap<>();");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public void doEffect(Move move, String name, Entity user, Entity enemy){");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t\t");
    _builder.append("float modifier = (float) 1.0;");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("String moveType = move.getMove(name).getType();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("String targetType = ");
    String _lowerCase_1 = effect.getRule().getTargetThen().toLowerCase();
    _builder.append(_lowerCase_1, "\t\t\t\t\t");
    _builder.append(".getType();");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t\t");
    _builder.append("Type type = Type.getInstance();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("HashMap<String, TypeRelation> typeRelations = type.getTypeRelations();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("TypeRelation typeRelation = typeRelations.get(targetType);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("if(typeRelation.getStrongAgainst().contains(moveType)){");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("modifier = typeRelation.getStrongRelationMultiplier();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("} else if(typeRelation.getWeakAgainst().contains(moveType)){");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("modifier = typeRelation.getWeakRelationMultiplier();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("}");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("aData.setNumber(aData.getNumber().floatValue() ");
    String _change = effect.getRule().getChange();
    _builder.append(_change, "\t\t\t\t\t");
    _builder.append(" (changeMove(move, name, user, enemy).floatValue() * modifier));");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t\t");
    ...
    _builder.append("\t\t\t\t");
    _builder.append("aData.setNumber(aData.getNumber().floatValue() ");
    String _change_1 = effect.getRule().getChange();
    _builder.append(_change_1, "\t\t\t\t");
    _builder.append(" changeMove(move, name, user, enemy).floatValue());");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t");
    _builder.append("System.out.println(");
    String _lowerCase_3 = effect.getRule().getTargetThen().toLowerCase();
  ...
  public CharSequence generateTypeRelation() {
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("private float strongRelationMultiplier;");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("private float weakRelationMultiplier;");
    _builder.newLine();
    _builder.append("\t\t    ");
    ...
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("public float getStrongRelationMultiplier(){");
    _builder.newLine();
    _builder.append("\t\t    \t");
    _builder.append("return strongRelationMultiplier;");
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("public void setStrongRelationMultiplier(float x){");
    _builder.newLine();
    _builder.append("\t\t    \t");
    _builder.append("strongRelationMultiplier = x;");
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("public float getWeakRelationMultiplier(){");
    _builder.newLine();
    _builder.append("\t\t    \t");
    _builder.append("return weakRelationMultiplier;");
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("public void setWeakRelationMultiplier(float x){");
    _builder.newLine();
    _builder.append("\t\t    \t");
    _builder.append("weakRelationMultiplier = x;");
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("}");
    _builder.newLine();
      ...
      for(final Type t : _type) {
        ...
        _builder.newLineIfNotEmpty();
        {
          ...
          if (_tripleNotEquals) {
            ...
            _builder.append("\t\t");
            _builder.append("tr.setStrongRelationMultiplier((float) ");
            Number _numberValue = this.getNumberValue(t.getTExpression().getRelationStrong());
            _builder.append(_numberValue, "\t\t");
            _builder.append(");");
            _builder.newLineIfNotEmpty();
            _builder.append("\t\t");
            _builder.append("tr.setWeakRelationMultiplier((float) ");
            Number _numberValue_1 = this.getNumberValue(t.getTExpression().getRelationWeak());
